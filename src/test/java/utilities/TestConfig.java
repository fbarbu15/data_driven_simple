...
public class TestConfig{
	...
	public static String from = "barbuflorinadrian@gmail.com";
	public static String password = "real_password_here";
	public static String[] to ={"barbu_florin_adrian@yahoo.com"};
